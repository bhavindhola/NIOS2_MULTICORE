...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../TOP.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../MULTICORE_SOBEL.sopcinfo
...
# Design Name 
# setting SOPC_NAME is MULTICORE_SOBEL
SOPC_NAME := MULTICORE_SOBEL
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1477407648
SOPC_SYSID_FLAG += --timestamp=1477407648
ELF_PATCH_FLAG  += --timestamp 1477407648
...
# setting hal.stderr is jtag_uart_2
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_2

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_2
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_2
...
# setting hal.stdout is jtag_uart_2
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_2
